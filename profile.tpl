        ...
        <div class="col-md-3">
            <div class="ia-item-author">
                ...
                <a class="ia-item-author__image" href="{ia_url type='url' item='members' data=$member}">
                    {printImage imgfile=$member.avatar width=120 title=$member.fullname|default:$member.username gravatar=true email=$member.email}
                </a>
                ...
                {if $member.facebook || $member.twitter || $member.gplus || $member.linkedin}
                    <p class="text-center">
                        {if !empty($member.facebook)}
                            <a href="{$member.facebook|escape}" class="fa-stack fa-lg" target="_blank"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-facebook fa-stack-1x fa-inverse"></i></a>
                        {/if}
                        {if !empty($member.twitter)}
                            <a href="{$member.twitter|escape}" class="fa-stack fa-lg" target="_blank"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-twitter fa-stack-1x fa-inverse"></i></a>
                        {/if}
                        {if !empty($member.gplus)}
                            <a href="{$member.gplus|escape}" class="fa-stack fa-lg" target="_blank"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-google-plus fa-stack-1x fa-inverse"></i></a>
                        {/if}
                        {if !empty($member.linkedin)}
                            <a href="{$member.linkedin|escape}" class="fa-stack fa-lg" target="_blank"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-linkedin fa-stack-1x fa-inverse"></i></a>
                        {/if}
                    </p>
                {/if}
            </div>
